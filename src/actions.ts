...
const actionCreators = {
    ...
    showAlternativeProfiles: (alternativeTargetDepth: number): A.ShowAlternativeProfilesAction => ({ type: A.Types.SHOW_ALTERNATIVE_PROFILES, payload: { alternativeTargetDepth } })
}
